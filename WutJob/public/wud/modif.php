   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#!"><i class="fa fa-database" aria-hidden="true"></i>  update</a>
        </div>
...
<div  class="container">
  <p style="text-align: center; color: #004d99 !important;">modifier les infos d'un membre ici</p>
  <hr>
...
<div class="col-sm-11 col-sm-offset-0">
        ...
        <div id="main-content">
         ...
         <div class="container">
          <div class="row">
           <?php
         if (isset($_GET['modif_membre'])) {
          include('modif_membre.php');
         }?>
